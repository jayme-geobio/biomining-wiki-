...
sed '1d' index.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/page.js
...
sed '1d' what-is-biomining.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/what-is-biomining/page.js

# fit-test
echo "'use client';" > app/fit-test/page.js
echo "" >> app/fit-test/page.js
echo "import Link from 'next/link';" >> app/fit-test/page.js
sed '1d' fit-test.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/fit-test/page.js
...
sed '1d' mining-academia.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/mining-academia/page.js
...
sed '1d' research-priorities.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/research-priorities/page.js
...
sed '1d' for-biologists.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/for-biologists/page.js

# for-miners
echo "'use client';" > app/for-miners/page.js
echo "" >> app/for-miners/page.js
echo "import Link from 'next/link';" >> app/for-miners/page.js
sed '1d' for-miners.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/for-miners/page.js

# glossary
echo "'use client';" > app/glossary/page.js
echo "" >> app/glossary/page.js
echo "import Link from 'next/link';" >> app/glossary/page.js
sed '1d' glossary.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/glossary/page.js
...
sed '1d' complex-materials.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/complex-materials/page.js

# flowsheets
echo "'use client';" > app/flowsheets/page.js
echo "" >> app/flowsheets/page.js
echo "import Link from 'next/link';" >> app/flowsheets/page.js
sed '1d' flowsheets.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/flowsheets/page.js

# research
echo "'use client';" > app/research/page.js
echo "" >> app/research/page.js
echo "import Link from 'next/link';" >> app/research/page.js
sed '1d' research.jsx | sed "s/<a href/<Link href/g; s/<\/a>/<\/Link>/g" >> app/research/page.js
