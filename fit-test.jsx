    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-indigo-900 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 flex justify-between">
          <a href="/what-is-biomining" className="text-indigo-400 hover:text-indigo-300 flex items-center gap-2">
            ← What Is Biomining?
          </a>
          <a href="/complex-materials" className="text-indigo-400 hover:text-indigo-300 flex items-center gap-2">
            Complex Materials →
          </a>
        </div>
      </div>
