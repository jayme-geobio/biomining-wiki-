export const glossaryData = {
  mining: [
    ...
    },
    {
      ...
      definition: "Lithium-selective processes for brines, such as adsorption, ion-sieve, or ion-exchange (IX) processes.",
    ...
    {
      term: "Open Pit Mine",
      definition: "A surface mining technique used to extract rock and minerals from an open excavation in the ground. Best suited to shallow, large, low-grade deposits, using explosives and heavy machinery to create a series of horizontal benches or terraces to access deeper ore. Typically cheaper per tonne and safer to operate than underground mining, but with a larger surface footprint.",
