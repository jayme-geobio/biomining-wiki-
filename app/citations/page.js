        ...
        <div className="bg-[#edede6] rounded-3xl shadow-2xl p-5 sm:p-8 md:p-12 border border-white">
          ...
          <div className="text-center mb-8">
            ...
            <p className="text-base text-[#264563] max-w-3xl mx-auto">
              In addition to the literature referenced throughout this handbook, we would like to acknowledge key workshop attendees whose insights inspired this resource: <strong>Mackenzie Best</strong>, <strong>Wenying Liu</strong>, <strong>Daniel Merino-Garcia</strong>, <strong>Sasha Milshteyn</strong>, <strong>Paul Reginato</strong>, <strong>Gerhard (Gary) Schenk</strong>, <strong>Alan Tordoir</strong>, and <strong>Luis Valencia</strong>. We also thank <strong>Ariana Caiati</strong>, <strong>Colbey Derwin</strong>, <strong>Jayme Feyhl-Buska</strong>, and the Homeworld team for bringing this handbook to life.
