    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-teal-900 p-6">
      <div className="max-w-5xl mx-auto">
        ...
        <div className="mt-12 flex justify-between">
          <Link href="/fit-test" className="text-teal-400 hover:text-teal-300 flex items-center gap-2">
            ← Fit Test
          </Link>
          <Link href="/research-priorities" className="text-teal-400 hover:text-teal-300 flex items-center gap-2">
            Research Priorities →
          </Link>
        </div>
      </div>
